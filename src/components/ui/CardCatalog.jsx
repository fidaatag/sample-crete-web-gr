const CardCatalog = ({title, bgImage, category, showCategory}) => {
    ...
    return (
      ...
      <div className="w-full h-52 lg:h-96 relative shadow rounded-lg">
        ...
        <div className="absolute bottom-0 w-full h-1/2 rounded-lg py-5 px-4 flex items-end justify-start text-center bg-gradient-to-b from-[rgba(7,11,27,0)] to-cyan-950 to-[70%] text-white">
